(function ($) {
    ...
    var worksheetapi = {
        ...
        submitWsCheckboxColumn : function(column, id, uniqueProperties, property) {
            ...
            wsColumn = null;
			// just for cst supplier search page
		    if (id=='suppliersTable') {
		    	var numOfUnchecked = $('#suppliersTable tbody td[@class="flag"] input[@type=checkbox][@checked=""]').length;
			  		if (numOfUnchecked == 0) {
			...
			// for cst inventories manage
		    if (id=='inventoriesTable') {
		    	var numOfUnchecked = $('#inventoriesTable tbody td[@class="flag"] input[@type=checkbox][@checked=""]').length;
			  		if (numOfUnchecked == 0) {
			  			$('#checkall').attr('checked', 'true');
			  		} else {
			  			$('#checkall').attr('checked', '');
		    ...
		    // for user authorized position manage compound setting user position table
		    if (id=='positionListTable') {
		    	var numOfUnchecked = $('#positionListTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUnchecked == 0) {
			  			$('#checkall').attr('checked', 'true');
			  		} else {
			  			$('#checkall').attr('checked', '');
		    ...
		    // for user authorized position manage user setting all user table
		     if (id=='userListTable') {
		    	var numOfUnchecked = $('#userListTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUnchecked == 0) {
			  			$('#checkall').attr('checked', 'true');
			  		} else {
			  			$('#checkall').attr('checked', '');
		     ...
		     // for user authorized position manage role setting role table
		     if (id=='roleListTable') {
		    	var numOfUnchecked = $('#roleListTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUnchecked == 0) {
			  			$('#checkall').attr('checked', 'true');
			  		} else {
			  			$('#checkall').attr('checked', '');
		    ...
		    //for project user role function
		    if (id=='currentUserListTable') {
		    	var numOfUnchecked = $('#currentUserListTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUnchecked == 0) {
			  			$('#currentUserListTable input[id="checkall"]').attr('checked', 'true');
			  		} else {
			  			$('#currentUserListTable input[id="checkall"]').attr('checked', '');
			  		}
		    }
		    if (id=='currentAllUserListTable') {
		    	var numOfUnchecked = $('#currentAllUserListTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUnchecked == 0) {
			  			$('#currentAllUserListTable input[id="checkall"]').attr('checked', 'true');
			  		} else {
			  			$('#currentAllUserListTable input[id="checkall"]').attr('checked', '');
			  		}
		    }
		    
		    if (id=='userListForBackTable') {
		    	var numOfUnchecked = $('#userListForBackTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUnchecked == 0) {
			  			$('#userListForBackTable input[id="checkall"]').attr('checked', 'true');
			  		} else {
			  			$('#userListForBackTable input[id="checkall"]').attr('checked', '');
			  		}
		    }
		    
		    // for user authorized project manage all user table
		     if (id=='projectAllUserListTable') {
		    	var numOfUncheckedBinded = $('#projectAllUserListTable tbody input[@type=checkbox][@checked=""][@id^=binded]').length;
			  		if (numOfUncheckedBinded == 0) {
			  			$('#ccc').attr('checked', 'true');
			  		} else {
			  			$('#ccc').attr('checked', '');
			  		}
			  		
			  	var numOfUncheckedMaster = $('#projectAllUserListTable tbody input[@type=checkbox][@checked=""][@id^=master]').length;
			  		if (numOfUncheckedMaster == 0) {
			  			$('#cc').attr('checked', 'true');
			  		} else {
			  			$('#cc').attr('checked', '');
			  		}
		    }
		    // for user authorized user manage all user table
		     if (id=='userManageUserListTable') {
		    	var numOfUncheckedBinded = $('#userManageUserListTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUncheckedBinded == 0) {
			  			$('#checkAllUser').attr('checked', 'true');
			  		} else {
			  			$('#checkAllUser').attr('checked', '');
			  		}
		    }
		    // for position add users table
		     if (id=='allUsersTable') {
		    	var numOfUncheckedBinded = $('#allUsersTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUncheckedBinded == 0) {
		    ...
		    // for project add position table
		     if (id=='allPositionsTable') {
		    	var numOfUncheckedBinded = $('#allPositionsTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUncheckedBinded == 0) {
			  			$('input[@name=flag]').attr('checked', 'true');
			  		} else {
			  			$('input[@name=flag]').attr('checked', '');
		    ...
		    // for roles add position table
		     if (id=='allRolesTable') {
		    	var numOfUncheckedBinded = $('#allRolesTable tbody input[@type=checkbox][@checked=""]').length;
			  		if (numOfUncheckedBinded == 0) {
			  			$('input[@name=flag]').attr('checked', 'true');
			  		} else {
			  			$('input[@name=flag]').attr('checked', '');
