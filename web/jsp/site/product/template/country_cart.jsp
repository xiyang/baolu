...
<div class="productToCard">
   <c:if test="${1 eq countryLevel && not empty product.actualPrice && product.actualPrice ne '0'}">
     <span id="addToCardIdSpan"><a class="addToCardA" id="addToCardId" href="${pageContext.request.contextPath}/order/add/${product.id}/1"><div class="addToCard hand">&nbsp;</div></a></span>
   </c:if>
