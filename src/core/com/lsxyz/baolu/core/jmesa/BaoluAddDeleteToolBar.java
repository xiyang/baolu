...
public class BaoluAddDeleteToolBar extends AbstractToolbar {



	public BaoluAddDeleteToolBar() {}
	...
	public String render() {
		...
		if(editable) {
			...
			//DeleteItem deleteItem = new DeleteItem(this.getWebContext(), this.getCoreContext(), "Remove");
