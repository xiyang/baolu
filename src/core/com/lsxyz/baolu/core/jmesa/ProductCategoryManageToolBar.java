...
public class ProductCategoryManageToolBar extends AbstractToolbar {

	public ProductCategoryManageToolBar() {
	}
	...
	public String render() {
		...
		boolean editable = ViewUtils.isEditable(this.getCoreContext().getWorksheet());
		if(editable) {
			addToolbarItem(ToolbarItemType.SEPARATOR);
			//add item
			AddItem addItem = new AddItem(this.getWebContext(), this.getCoreContext(), "Add");
			addToolbarItem(addItem);
			// recommend item
			//RecommendItem recommendItem = new RecommendItem(this.getWebContext(), this.getCoreContext(), "Recommend");
			//addToolbarItem(recommendItem);
			//delete item
			//DeleteItem deleteItem = new DeleteItem(this.getWebContext(), this.getCoreContext(), "Disabled");
			//addToolbarItem(deleteItem);
		}
